...
<section class="cart-items">
    ...
    <?php else: ?>
        ...
        <div class="cart-total-block">
            ...
            <p class="total-amount"><?= $total ?> грн</p>
        </div>
...
<aside class="cart-summary">
    <h2>Підсумок</h2>
    <div class="summary-row"><span>Сума</span><span><?= $total ?> грн</span></div>
    <div class="summary-row"><span>Доставка</span><span>Безкоштовно від 300 грн</span></div>
    <div class="summary-total"><span>Разом</span><span><?= $total ?> грн</span></div>
</aside>
